...
if env['version'] == '3.x':
    env.Append(CPPPATH=[
       ...
       env.Append(CPPPATH=[
        ...
        'godot', 
        'godot/platform/ios',
	'plugins/BiFirebaseGodot/libs/Firebase/FirebaseCore.xcframework/ios-arm64/FirebaseCore.framework/FirebaseCore.framework/Headers',
	'plugins/BiFirebaseGodot/libs/Firebase/FirebaseMessaging.xcframework/ios-arm64/FirebaseMessaging.framework/Headers',
